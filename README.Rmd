...
## Get Started
1. Copy three code files (including `start_sim.R`, `job_config.job`, `main.R`) in the folder `Code-copy_me` to your working directory on the cluster.
